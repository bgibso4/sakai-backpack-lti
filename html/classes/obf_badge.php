...
class obf_badge
{
     ...
     *
     * @param badge $another Badge to compare to
     * @return bool $this matches $another
     */
    public function equals(badge $another) {
     ...
     */
    public function image_equals(badge $another) {
     ...
     *
     * @return badge|boolean Returns the badge on success, false otherwise.
     */
